...
const uint8_t max_straight_ticks = 255; /* set the \tau_m period to 2.5 s: n_m = \tau_m/\delta_t = 2.5/(1/32) */
const uint8_t max_broadcast_ticks = 255;  /* set the \tau_s period to 2.5 s: n_s = \tau_s/\delta_t = 2.5/(1/32) */
